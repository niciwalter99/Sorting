...
void rt_OneStep(void)
{
   ...
   */
  WinkelTest_SetEventsForThisBaseStep(eventFlags);
...
int main(void)
{
  ...
  ;
  rtmSetErrorStatus(WinkelTest_M, 0);
  WinkelTest_initialize();
  configureTimer0(modelBaseRate, systemClock);
  runModel =
    rtmGetErrorStatus(WinkelTest_M) == (NULL);
  enableTimer0Interrupt();
