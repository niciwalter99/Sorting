###########################################################################
## Makefile generated for Simulink model 'PoluluSortierenMitRandom'. 
## 
## Makefile     : PoluluSortierenMitRandom.mk
## Generated on : Sun Dec 13 15:56:50 2020
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PoluluSortierenMitRandom.out
...
PRODUCT_NAME              = PoluluSortierenMitRandom
MAKEFILE                  = PoluluSortierenMitRandom.mk
COMPUTER                  = PCWIN64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PoluluSortierenMitRandom.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/PoluluSortierenMitRandom_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/SUPPOR~1/tic2000/inc -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/SUPPOR~1/tic2000/src -I$(MATLAB_ROOT)/toolbox/rtw/targets/common/can/blocks/tlc_c -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2018b/toolbox/target/shared/EXTERN~1/include
...
DEFINES_ = -DMODEL=PoluluSortierenMitRandom -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=1 -DDAEMON_MODE=1 -DMW_PIL_SCIFIFOLEN=16 -DSTACK_SIZE=512 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DF28335 -DBOOT_FROM_FLASH=0
...
DEFINES_STANDARD = -DMODEL=PoluluSortierenMitRandom -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/PoluluSortierenMitRandom_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/PoluluSortierenMitRandom_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/PoluluSortierenMitRandom_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file=$@ $<


%.obj : $(START_DIR)/PoluluSortierenMitRandom_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file=$@ $<
