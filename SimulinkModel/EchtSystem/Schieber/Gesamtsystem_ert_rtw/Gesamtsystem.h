...
typedef struct {
  ...
  rtB_MATLABFunction1_Gesamtsyste sf_MATLABFunction3;/* '<S35>/MATLAB Function3' */
  rtB_MATLABFunction1_Gesamtsyste sf_MATLABFunction1;/* '<S35>/MATLAB Function1' */
  rtB_POSITIVEEdge_Gesamtsystem POSITIVEEdge_i;/* '<S37>/POSITIVE Edge' */
  rtB_NEGATIVEEdge_Gesamtsystem NEGATIVEEdge_h;/* '<S37>/NEGATIVE Edge' */
  rtB_POSITIVEEdge_Gesamtsystem POSITIVEEdge;/* '<S36>/POSITIVE Edge' */
  rtB_NEGATIVEEdge_Gesamtsystem NEGATIVEEdge;/* '<S36>/NEGATIVE Edge' */
...
typedef struct {
  ...
  uint16_T is_active_c15_Gesamtsystem; /* '<S5>/Sortieralgorithmus' */
  uint16_T is_c15_Gesamtsystem;        /* '<S5>/Sortieralgorithmus' */
  uint16_T is_active_c6_Gesamtsystem;  /* '<S5>/Chart2' */
  uint16_T is_c6_Gesamtsystem;         /* '<S5>/Chart2' */
  uint16_T temporalCounter_i1_k;       /* '<S5>/Chart2' */
  uint16_T is_active_c4_Gesamtsystem;  /* '<S5>/Chart1' */
  uint16_T is_c4_Gesamtsystem;         /* '<S5>/Chart1' */
  uint16_T is_active_c3_Gesamtsystem;  /* '<S5>/Chart' */
  uint16_T is_c3_Gesamtsystem;         /* '<S5>/Chart' */
  uint16_T temporalCounter_i1_e;       /* '<S5>/Chart' */
  uint16_T is_active_c17_Gesamtsystem; /* '<S4>/Chart8' */
  uint16_T is_c17_Gesamtsystem;        /* '<S4>/Chart8' */
  uint16_T is_active_c16_Gesamtsystem; /* '<S4>/Chart6' */
  uint16_T is_c16_Gesamtsystem;        /* '<S4>/Chart6' */
  uint16_T is_active_c14_Gesamtsystem; /* '<S4>/Chart4' */
  uint16_T is_c14_Gesamtsystem;        /* '<S4>/Chart4' */
  uint16_T is_active_c13_Gesamtsystem; /* '<S4>/Chart2' */
  uint16_T is_c13_Gesamtsystem;        /* '<S4>/Chart2' */
  uint16_T is_active_c1_Gesamtsystem;  /* '<S4>/Chart1' */
  uint16_T is_c1_Gesamtsystem;         /* '<S4>/Chart1' */
  uint16_T is_active_c12_Gesamtsystem; /* '<S9>/Winkelausgabe fuer Ausrichtung' */
  uint16_T is_c12_Gesamtsystem;        /* '<S9>/Winkelausgabe fuer Ausrichtung' */
  uint16_T is_active_c11_Gesamtsystem; /* '<S9>/Quadrantenteiler' */
  uint16_T is_c11_Gesamtsystem;        /* '<S9>/Quadrantenteiler' */
  uint16_T is_active_c7_Gesamtsystem;  /* '<S3>/Fahrsystem' */
  uint16_T is_c7_Gesamtsystem;         /* '<S3>/Fahrsystem' */
  uint16_T is_active_c8_Gesamtsystem;  /* '<S3>/Drehweg-Optimierung mit Gang-Ausrichtung [Init: Stillstandintervall = ±5°]' */
  uint16_T is_c8_Gesamtsystem;         /* '<S3>/Drehweg-Optimierung mit Gang-Ausrichtung [Init: Stillstandintervall = ±5°]' */
  uint16_T is_active_c5_Gesamtsystem;  /* '<Root>/Fahrablaufsteuerung [Init: Zielradius = 5mm] Gang = 0: vorwaerts Gang = 1: rueckwaerts Folgende Werte fuer den Ablauf sind einstellbar: - Zielkoordinatenwerte - Gangwert - ' */
  uint16_T is_c5_Gesamtsystem;         /* '<Root>/Fahrablaufsteuerung [Init: Zielradius = 5mm] Gang = 0: vorwaerts Gang = 1: rueckwaerts Folgende Werte fuer den Ablauf sind einstellbar: - Zielkoordinatenwerte - Gangwert - ' */
 ...
 *
 * '<Root>' : 'Gesamtsystem'
 * '<S1>'   : 'Gesamtsystem/Fahrablaufsteuerung [Init: Zielradius = 5mm] Gang = 0: vorwaerts Gang = 1: rueckwaerts Folgende Werte fuer den Ablauf sind einstellbar: - Zielkoordinatenwerte - Gangwert - '
 * '<S2>'   : 'Gesamtsystem/Motorausgang'
 * '<S3>'   : 'Gesamtsystem/Navigationssystem [Einstellungen moeglich]'
 * '<S4>'   : 'Gesamtsystem/Nexonar-Positionsbestimmung'
 * '<S5>'   : 'Gesamtsystem/Subsystem'
 * '<S6>'   : 'Gesamtsystem/Navigationssystem [Einstellungen moeglich]/Drehweg-Optimierung mit Gang-Ausrichtung [Init: Stillstandintervall = ±5°]'
 * '<S7>'   : 'Gesamtsystem/Navigationssystem [Einstellungen moeglich]/Fahrsystem'
 * '<S8>'   : 'Gesamtsystem/Navigationssystem [Einstellungen moeglich]/Positionsregelungssystem (Soll-Ist-Abgleich & PWM-Auswertung)'
 * '<S9>'   : 'Gesamtsystem/Navigationssystem [Einstellungen moeglich]/Winkelregelungssystem (Soll-Ist-Abgleich & Ausrichtungsauswertung)'
 * '<S10>'  : 'Gesamtsystem/Navigationssystem [Einstellungen moeglich]/Positionsregelungssystem (Soll-Ist-Abgleich & PWM-Auswertung)/Betrag pwm_x'
 * '<S11>'  : 'Gesamtsystem/Navigationssystem [Einstellungen moeglich]/Positionsregelungssystem (Soll-Ist-Abgleich & PWM-Auswertung)/Betrag pwm_y'
 * '<S12>'  : 'Gesamtsystem/Navigationssystem [Einstellungen moeglich]/Positionsregelungssystem (Soll-Ist-Abgleich & PWM-Auswertung)/PWM-Vektorbetrag'
 * '<S13>'  : 'Gesamtsystem/Navigationssystem [Einstellungen moeglich]/Winkelregelungssystem (Soll-Ist-Abgleich & Ausrichtungsauswertung)/Quadrantenteiler'
 * '<S14>'  : 'Gesamtsystem/Navigationssystem [Einstellungen moeglich]/Winkelregelungssystem (Soll-Ist-Abgleich & Ausrichtungsauswertung)/Winkelausgabe fuer Ausrichtung'
 * '<S15>'  : 'Gesamtsystem/Nexonar-Positionsbestimmung/Chart1'
 * '<S16>'  : 'Gesamtsystem/Nexonar-Positionsbestimmung/Chart2'
 * '<S17>'  : 'Gesamtsystem/Nexonar-Positionsbestimmung/Chart4'
 * '<S18>'  : 'Gesamtsystem/Nexonar-Positionsbestimmung/Chart6'
 * '<S19>'  : 'Gesamtsystem/Nexonar-Positionsbestimmung/Chart8'
 * '<S20>'  : 'Gesamtsystem/Nexonar-Positionsbestimmung/I2C Reset (behebt Stabilitätsprobleme der I2C-Verbindung)'
 * '<S21>'  : 'Gesamtsystem/Nexonar-Positionsbestimmung/Triggered Subsystem'
 * '<S22>'  : 'Gesamtsystem/Nexonar-Positionsbestimmung/I2C Reset (behebt Stabilitätsprobleme der I2C-Verbindung)/I2C Reinitialisierung'
 * '<S23>'  : 'Gesamtsystem/Nexonar-Positionsbestimmung/I2C Reset (behebt Stabilitätsprobleme der I2C-Verbindung)/I2C Reset'
 * '<S24>'  : 'Gesamtsystem/Nexonar-Positionsbestimmung/I2C Reset (behebt Stabilitätsprobleme der I2C-Verbindung)/I2C Reinitialisierung/I2C Reinitialisierung'
 * '<S25>'  : 'Gesamtsystem/Nexonar-Positionsbestimmung/I2C Reset (behebt Stabilitätsprobleme der I2C-Verbindung)/I2C Reset/I2C Reset'
 * '<S26>'  : 'Gesamtsystem/Subsystem/Chart'
 * '<S27>'  : 'Gesamtsystem/Subsystem/Chart1'
 * '<S28>'  : 'Gesamtsystem/Subsystem/Chart2'
 * '<S29>'  : 'Gesamtsystem/Subsystem/P-Regler mit Output'
 * '<S30>'  : 'Gesamtsystem/Subsystem/Sortieralgorithmus'
 * '<S31>'  : 'Gesamtsystem/Subsystem/getAngle'
 * '<S32>'  : 'Gesamtsystem/Subsystem/P-Regler mit Output/P-Regler mit Regelfehler Begrenzung Initial: k = 0.1, limiit = +//- 100 Sampletime 0.01'
 * '<S33>'  : 'Gesamtsystem/Subsystem/P-Regler mit Output/P-Regler mit Regelfehler Begrenzung Initial: k = 0.1, limiit = +//- 100 Sampletime 0.01/Betrag'
 * '<S34>'  : 'Gesamtsystem/Subsystem/P-Regler mit Output/P-Regler mit Regelfehler Begrenzung Initial: k = 0.1, limiit = +//- 100 Sampletime 0.01/Richtung'
 * '<S35>'  : 'Gesamtsystem/Subsystem/getAngle/Messung des absoluten Winkels -  Auswertung der Encodersignale'
 * '<S36>'  : 'Gesamtsystem/Subsystem/getAngle/Messung des absoluten Winkels -  Auswertung der Encodersignale/Edge Detector1'
 * '<S37>'  : 'Gesamtsystem/Subsystem/getAngle/Messung des absoluten Winkels -  Auswertung der Encodersignale/Edge Detector2'
 * '<S38>'  : 'Gesamtsystem/Subsystem/getAngle/Messung des absoluten Winkels -  Auswertung der Encodersignale/MATLAB Function1'
 * '<S39>'  : 'Gesamtsystem/Subsystem/getAngle/Messung des absoluten Winkels -  Auswertung der Encodersignale/MATLAB Function2'
 * '<S40>'  : 'Gesamtsystem/Subsystem/getAngle/Messung des absoluten Winkels -  Auswertung der Encodersignale/MATLAB Function3'
 * '<S41>'  : 'Gesamtsystem/Subsystem/getAngle/Messung des absoluten Winkels -  Auswertung der Encodersignale/Edge Detector1/NEGATIVE Edge'
 * '<S42>'  : 'Gesamtsystem/Subsystem/getAngle/Messung des absoluten Winkels -  Auswertung der Encodersignale/Edge Detector1/POSITIVE Edge'
 * '<S43>'  : 'Gesamtsystem/Subsystem/getAngle/Messung des absoluten Winkels -  Auswertung der Encodersignale/Edge Detector2/NEGATIVE Edge'
 * '<S44>'  : 'Gesamtsystem/Subsystem/getAngle/Messung des absoluten Winkels -  Auswertung der Encodersignale/Edge Detector2/POSITIVE Edge'
 */
