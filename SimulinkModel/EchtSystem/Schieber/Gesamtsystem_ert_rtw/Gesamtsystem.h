...
typedef struct {
  ...
  uint16_T is_active_c25_Gesamtsystem; /* '<S13>/Chart8' */
  uint16_T is_c25_Gesamtsystem;        /* '<S13>/Chart8' */
  uint16_T is_active_c24_Gesamtsystem; /* '<S13>/Chart6' */
  uint16_T is_c24_Gesamtsystem;        /* '<S13>/Chart6' */
  uint16_T is_active_c21_Gesamtsystem; /* '<S13>/Chart4' */
  uint16_T is_c21_Gesamtsystem;        /* '<S13>/Chart4' */
  uint16_T is_active_c17_Gesamtsystem; /* '<S13>/Chart2' */
  uint16_T is_c17_Gesamtsystem;        /* '<S13>/Chart2' */
  uint16_T is_active_c16_Gesamtsystem; /* '<S13>/Chart1' */
  uint16_T is_c16_Gesamtsystem;        /* '<S13>/Chart1' */
  uint16_T is_active_c14_Gesamtsystem; /* '<S17>/Winkelausgabe fuer Ausrichtung' */
  uint16_T is_c14_Gesamtsystem;        /* '<S17>/Winkelausgabe fuer Ausrichtung' */
  uint16_T is_active_c13_Gesamtsystem; /* '<S17>/Quadrantenteiler' */
  uint16_T is_c13_Gesamtsystem;        /* '<S17>/Quadrantenteiler' */
  uint16_T is_active_c11_Gesamtsystem; /* '<S12>/Fahrsystem' */
  uint16_T is_c11_Gesamtsystem;        /* '<S12>/Fahrsystem' */
