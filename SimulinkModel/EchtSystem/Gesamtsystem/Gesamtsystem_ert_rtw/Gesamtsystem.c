    ...
    /* Output and update for function-call system: '<S17>/Triggered Subsystem' */
    {
      ...
      for (i = 0; i < 10; i++) {
        ...
        Gesamtsystem_B.VectorConcatenate[i] =
          Gesamtsystem_DWork.Delay_DSTATE_h[i];

        /* Update for Delay: '<S34>/Delay' */
        Gesamtsystem_DWork.Delay_DSTATE_h[i] = Gesamtsystem_B.I2CReceive_o1[i];
      }
    }
...
static real_T Gesamtsystem_findPlaceForBlue(void)
{
  ...
  if (Gesamtsystem_DWork.magacin2 < 2.0) {
    /* '<S43>:206:3' */
    /* '<S43>:206:4' */
    magacinOut = 2.0;
    ...
    /* '<S43>:206:6' */
  } else if ((Gesamtsystem_DWork.magacin1 == 1.0) ||
             (Gesamtsystem_DWork.magacin1 == 2.0)) {
    /* '<S43>:206:7' */
    /* '<S43>:206:8' */
    magacinOut = 1.0;
    ...
    /* '<S43>:206:10' */
  } else if (Gesamtsystem_DWork.magacin2 == 4.0) {
    /* '<S43>:206:11' */
    /* '<S43>:206:12' */
    magacinOut = 2.0;
    ...
    /* '<S43>:206:14' */
  } else if (Gesamtsystem_DWork.magacin0 == 4.0) {
    /* '<S43>:206:15' */
    /* '<S43>:206:16' */
    magacinOut = 0.0;
...
static real_T Gesamtsystem_findPlaceForRed(void)
{
  ...
  if (Gesamtsystem_DWork.magacin1 == 0.0) {
    ...
    /* '<S43>:204:6' */
  } else if ((Gesamtsystem_DWork.magacin2 == 2.0) ||
             (Gesamtsystem_DWork.magacin2 == 3.0)) {
    /* '<S43>:204:7' */
    /* '<S43>:204:8' */
    magacinOut = 2.0;
    ...
    /* '<S43>:204:14' */
  } else if (Gesamtsystem_DWork.magacin1 >= 2.0) {
    /* '<S43>:204:15' */
    /* '<S43>:204:16' */
    magacinOut = 1.0;
...
void Gesamtsystem_step1(void)          /* Sample time: [0.01s, 0.0s] */
{
  ...
  if (Gesamtsystem_DWork.temporalCounter_i1_o < MAX_uint32_T) {
    Gesamtsystem_DWork.temporalCounter_i1_o++;
  }
        ...
        switch (Gesamtsystem_DWork.is_Uebergabe) {
         ...
         case Ge_IN_Uebergabepunkt_y_Richtung:
          ...
          if (Gesamtsystem_B.SignaleingangfuerHeckschalter) {
            ...
            Gesamtsystem_DWork.temporalCounter_i1_o = 0UL;
         ...
         case Gesamtsyste_IN_Warten_Uebergabe:
          ...
          if (Gesamtsystem_DWork.temporalCounter_i1_o >= (uint32_T)ceil
  ...
  rtb_RoundingFunction = Gesamtsystem_P.Inkrement_Value +
    Gesamtsystem_DWork.Delay_DSTATE_i;
  ...
  if (Gesamtsystem_DWork.temporalCounter_i1_ac < 15U) {
    Gesamtsystem_DWork.temporalCounter_i1_ac = ((int16_T)
      Gesamtsystem_DWork.temporalCounter_i1_ac + 1) & 255U;
  }
  ...
  if (Gesamtsystem_DWork.is_active_c6_Gesamtsystem == 0U) {
    ...
    switch (Gesamtsystem_DWork.is_c6_Gesamtsystem) {
     case Gesamtsystem_IN_Ausfuehrung:
      ...
      if (Gesamtsystem_DWork.temporalCounter_i1_ac >= 10U) {
        /* Transition: '<S11>:1013' */
     ...
     default:
      ...
      if ((Gesamtsystem_B.x_soll == 1200.0) && (Gesamtsystem_B.y_soll == -50.0))
      {
        ...
        Gesamtsystem_DWork.temporalCounter_i1_ac = 0U;
  ...
  if (Gesamtsystem_DWork.temporalCounter_i1_op < 255U) {
    Gesamtsystem_DWork.temporalCounter_i1_op = ((int16_T)
      Gesamtsystem_DWork.temporalCounter_i1_op + 1) & 255U;
  }
  ...
  if (Gesamtsystem_DWork.is_active_c42_Gesamtsystem == 0U) {
    ...
    switch (Gesamtsystem_DWork.is_c42_Gesamtsystem) {
     case Gesamtsystem_IN_Black:
      ...
      if (Gesamtsystem_DWork.temporalCounter_i1_op >= 100U) {
        /* Transition: '<S43>:188' */
     ...
     case IN_photoelectricBarrierActivate:
      ...
      if (Gesamtsystem_B.MovingAverage2 > 2150.0) {
        ...
        Gesamtsystem_DWork.temporalCounter_i1_op = 0U;
     ...
     default:
      /* During 'wait': '<S43>:218' */
      if (Gesamtsystem_DWork.temporalCounter_i1_op >= 200U) {
        /* Transition: '<S43>:220' */
        Gesamtsystem_DWork.is_c42_Gesamtsystem = Gesamtsystem_IN_cubeLoaded;
  ...
  Gesamtsystem_DWork.Delay_DSTATE_i = rtb_RoundingFunction;
...
void Gesamtsystem_initialize(void)
{
...

  {
    ...
    Gesamtsystem_DWork.Delay_DSTATE_i = Gesamtsystem_P.Delay_InitialCondition_j;
    ...
    /* System initialize for function-call system: '<S17>/Triggered Subsystem' */
    {
      ...
      for (i = 0; i < 10; i++) {
        Gesamtsystem_DWork.Delay_DSTATE_h[i] =
          Gesamtsystem_P.Delay_InitialCondition_m;
      }
