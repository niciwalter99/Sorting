...
typedef struct {
<<<<<<< HEAD
  real_T TmpRTBAtChart8Outport3;       /* '<S3>/Chart8' */
...
<<<<<<< HEAD
  ...
  rtB_MATLABFunction1_Gesamtsyste sf_MATLABFunction3;/* '<S43>/MATLAB Function3' */
  rtB_MATLABFunction1_Gesamtsyste sf_MATLABFunction1;/* '<S43>/MATLAB Function1' */
  rtB_POSITIVEEdge_Gesamtsystem POSITIVEEdge_n;/* '<S45>/POSITIVE Edge' */
  rtB_NEGATIVEEdge_Gesamtsystem NEGATIVEEdge_i;/* '<S45>/NEGATIVE Edge' */
  rtB_POSITIVEEdge_Gesamtsystem POSITIVEEdge;/* '<S44>/POSITIVE Edge' */
  rtB_NEGATIVEEdge_Gesamtsystem NEGATIVEEdge;/* '<S44>/NEGATIVE Edge' */
=======
...
<<<<<<< HEAD
  real_T UnitDelay5_DSTATE;            /* '<S43>/Unit Delay5' */
  real_T TmpRTBAtChart8Outport3_Buffer0;/* synthesized block */
=======
...
<<<<<<< HEAD
  ...
  real32_T UnitDelay2_DSTATE;          /* '<S43>/Unit Delay2' */
  ...
  uint16_T temporalCounter_i1;         /* '<S2>/Fahrablaufsteuerung [Init: Zielradius = 10mm] Gang = 0: vorwaerts Gang = 1: rueckwaerts Folgende Werte fuer den Ablauf sind einstellbar: - Zielkoordinatenwerte - Gangwert' */
  uint16_T Delay_DSTATE[10];           /* '<S28>/Delay' */
  boolean_T UnitDelay3_DSTATE;         /* '<S43>/Unit Delay3' */
  boolean_T UnitDelay4_DSTATE;         /* '<S43>/Unit Delay4' */
...
<<<<<<< HEAD
  ...
  boolean_T Memory_PreviousInput_n;    /* '<S45>/Memory' */
=======
...
<<<<<<< HEAD
  ...
  real_T posedge_Value_c[2];           /* Expression: [1 0]
                                        ...
                                        */
  real_T TmpRTBAtChart8Outport3_InitialC;/* Expression: 0
 ...
 * '<S33>'  : 'Gesamtsystem/Subsystem/Chart6'
 * '<S34>'  : 'Gesamtsystem/Subsystem/Chart7'
 * '<S35>'  : 'Gesamtsystem/Subsystem/Chart8'
 * '<S36>'  : 'Gesamtsystem/Subsystem/P-Regler mit Output2'
 * '<S37>'  : 'Gesamtsystem/Subsystem/Sortieralgorithmus2'
 * '<S38>'  : 'Gesamtsystem/Subsystem/Subsystem2'
 * '<S39>'  : 'Gesamtsystem/Subsystem/getAngle2'
 * '<S40>'  : 'Gesamtsystem/Subsystem/P-Regler mit Output2/P-Regler mit Regelfehler Begrenzung Initial: k = 0.1, limiit = +//- 100 Sampletime 0.01'
 * '<S41>'  : 'Gesamtsystem/Subsystem/P-Regler mit Output2/P-Regler mit Regelfehler Begrenzung Initial: k = 0.1, limiit = +//- 100 Sampletime 0.01/Betrag'
 * '<S42>'  : 'Gesamtsystem/Subsystem/P-Regler mit Output2/P-Regler mit Regelfehler Begrenzung Initial: k = 0.1, limiit = +//- 100 Sampletime 0.01/Richtung'
 * '<S43>'  : 'Gesamtsystem/Subsystem/getAngle2/Messung des absoluten Winkels -  Auswertung der Encodersignale'
 * '<S44>'  : 'Gesamtsystem/Subsystem/getAngle2/Messung des absoluten Winkels -  Auswertung der Encodersignale/Edge Detector1'
 * '<S45>'  : 'Gesamtsystem/Subsystem/getAngle2/Messung des absoluten Winkels -  Auswertung der Encodersignale/Edge Detector2'
 * '<S46>'  : 'Gesamtsystem/Subsystem/getAngle2/Messung des absoluten Winkels -  Auswertung der Encodersignale/MATLAB Function1'
 * '<S47>'  : 'Gesamtsystem/Subsystem/getAngle2/Messung des absoluten Winkels -  Auswertung der Encodersignale/MATLAB Function2'
 * '<S48>'  : 'Gesamtsystem/Subsystem/getAngle2/Messung des absoluten Winkels -  Auswertung der Encodersignale/MATLAB Function3'
 * '<S49>'  : 'Gesamtsystem/Subsystem/getAngle2/Messung des absoluten Winkels -  Auswertung der Encodersignale/Edge Detector1/NEGATIVE Edge'
 * '<S50>'  : 'Gesamtsystem/Subsystem/getAngle2/Messung des absoluten Winkels -  Auswertung der Encodersignale/Edge Detector1/POSITIVE Edge'
 * '<S51>'  : 'Gesamtsystem/Subsystem/getAngle2/Messung des absoluten Winkels -  Auswertung der Encodersignale/Edge Detector2/NEGATIVE Edge'
 * '<S52>'  : 'Gesamtsystem/Subsystem/getAngle2/Messung des absoluten Winkels -  Auswertung der Encodersignale/Edge Detector2/POSITIVE Edge'
=======
