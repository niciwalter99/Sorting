 ...
 *
 * File: GesamtsystemAltV2_types.h
 *
...
#ifndef RTW_HEADER_GesamtsystemAltV2_types_h_
#define RTW_HEADER_GesamtsystemAltV2_types_h_
#include "rtwtypes.h"
...
#ifndef typedef_cell_wrap_GesamtsystemAltV2
#define typedef_cell_wrap_GesamtsystemAltV2

typedef struct {
  uint32_T f1[8];
} cell_wrap_GesamtsystemAltV2;

#endif                                 /*typedef_cell_wrap_GesamtsystemAltV2*/
...
typedef struct {
  ...
  boolean_T isSetupComplete;
  boolean_T TunablePropsChanged;
  cell_wrap_GesamtsystemAltV2 inputVarSize;
  real_T ForgettingFactor;
...
typedef struct Parameters_GesamtsystemAltV2_ Parameters_GesamtsystemAltV2;

/* Forward declaration for rtModel */
typedef struct tag_RTM_GesamtsystemAltV2 RT_MODEL_GesamtsystemAltV2;

#endif                                 /* RTW_HEADER_GesamtsystemAltV2_types_h_ */
