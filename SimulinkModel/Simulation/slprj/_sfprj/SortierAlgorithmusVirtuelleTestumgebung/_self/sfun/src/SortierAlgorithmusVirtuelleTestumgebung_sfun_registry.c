...
{
  extern unsigned int
    sf_SortierAlgorithmusVirtuelleTestumgebung_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_SortierAlgorithmusVirtuelleTestumgebung_process_check_sum_call(nlhs,
       plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_SortierAlgorithmusVirtuelleTestumgebung_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "SortierAlgorithmusVirtuelleTestumgebung") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_SortierAlgorithmusVirtuelleTestumgebung_autoinheritance_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_SortierAlgorithmusVirtuelleTestumgebung_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "SortierAlgorithmusVirtuelleTestumgebung") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_SortierAlgorithmusVirtuelleTestumgebung_third_party_uses_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_SortierAlgorithmusVirtuelleTestumgebung_jit_fallback_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "SortierAlgorithmusVirtuelleTestumgebung") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_SortierAlgorithmusVirtuelleTestumgebung_jit_fallback_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_SortierAlgorithmusVirtuelleTestumgebung_updateBuildInfo_args_info( int
  ...
  if (strcmp(machineName, "SortierAlgorithmusVirtuelleTestumgebung") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_SortierAlgorithmusVirtuelleTestumgebung_updateBuildInfo_args_info
      (nlhs,plhs,3,newRhs);
  }
...
extern unsigned int sf_SortierAlgorithmusVirtuelleTestumgebung_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"SortierAlgorithmusVirtuelleTestumgebung")) {
    return(sf_SortierAlgorithmusVirtuelleTestumgebung_method_dispatcher
...
void sf_machine_global_terminator(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    SortierAlgorithmusVirtuelleTestumgebung_terminator();
    slcovUploadCoverageSynthesisById(
      "SortierAlgorithmusVirtuelleTestumgebung@SortierAlgorithmusVirtuelleTestumgebung");
...
extern void SortierAlgorithmusVirtuelleTestumgebung_register_exported_symbols
  (SimStruct* S);
extern void SortierAlgorithmusVirtuelleTestumgebung_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  SortierAlgorithmusVirtuelleTestumgebung_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      SortierAlgorithmusVirtuelleTestumgebung_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    SortierAlgorithmusVirtuelleTestumgebung_initializer();
    slcovUploadCoverageSynthesisById(
      "SortierAlgorithmusVirtuelleTestumgebung@SortierAlgorithmusVirtuelleTestumgebung");
  }
